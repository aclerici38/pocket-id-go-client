...
type GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto struct {
	...
	// webauthn allow synced passkeys
	// Required: true
	// Enum: ["true","false"]
...
func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateEmailVerificationEnabled(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := m.validateWebauthnAllowSyncedPasskeys(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateWebauthnAuthenticatorAttachment(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateWebauthnUserVerification(formats); err != nil {
		res = append(res, err)
	}
...
func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateEmailVerificationEnabled(formats strfmt.Registry) error {

	if err := validate.Required("emailVerificationEnabled", "body", m.EmailVerificationEnabled); err != nil {
		return err
	}
...
func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateHomePageURL(formats strfmt.Registry) error {

	if err := validate.Required("homePageUrl", "body", m.HomePageURL); err != nil {
		return err
	}
...
var githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAllowSyncedPasskeysPropEnum []any
...
func init() {
	...
	for _, v := range res {
		githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAllowSyncedPasskeysPropEnum = append(githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAllowSyncedPasskeysPropEnum, v)
	}
}

const (

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAllowSyncedPasskeysTrue captures enum value "true"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAllowSyncedPasskeysTrue string = "true"

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAllowSyncedPasskeysFalse captures enum value "false"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAllowSyncedPasskeysFalse string = "false"
)

// prop value enum
func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateWebauthnAllowSyncedPasskeysEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAllowSyncedPasskeysPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateWebauthnAllowSyncedPasskeys(formats strfmt.Registry) error {

	if err := validate.Required("webauthnAllowSyncedPasskeys", "body", m.WebauthnAllowSyncedPasskeys); err != nil {
		return err
	}

	// value enum
	if err := m.validateWebauthnAllowSyncedPasskeysEnum("webauthnAllowSyncedPasskeys", "body", *m.WebauthnAllowSyncedPasskeys); err != nil {
		return err
	}
...
var githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAuthenticatorAttachmentPropEnum []any

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["any","platform","cross-platform"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAuthenticatorAttachmentPropEnum = append(githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAuthenticatorAttachmentPropEnum, v)
	}
}

const (

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAuthenticatorAttachmentAny captures enum value "any"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAuthenticatorAttachmentAny string = "any"

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAuthenticatorAttachmentPlatform captures enum value "platform"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAuthenticatorAttachmentPlatform string = "platform"

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAuthenticatorAttachmentCrossDashPlatform captures enum value "cross-platform"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnAuthenticatorAttachmentCrossDashPlatform string = "cross-platform"
)

// prop value enum
func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateWebauthnAuthenticatorAttachmentEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnAuthenticatorAttachmentPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateWebauthnAuthenticatorAttachment(formats strfmt.Registry) error {

	if err := validate.Required("webauthnAuthenticatorAttachment", "body", m.WebauthnAuthenticatorAttachment); err != nil {
		return err
	}

	// value enum
	if err := m.validateWebauthnAuthenticatorAttachmentEnum("webauthnAuthenticatorAttachment", "body", *m.WebauthnAuthenticatorAttachment); err != nil {
		return err
	}
...
var githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnUserVerificationPropEnum []any

func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["required","preferred"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
		githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnUserVerificationPropEnum = append(githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnUserVerificationPropEnum, v)
	}
}

const (

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnUserVerificationRequired captures enum value "required"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnUserVerificationRequired string = "required"

	// GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnUserVerificationPreferred captures enum value "preferred"
	GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDtoWebauthnUserVerificationPreferred string = "preferred"
)

// prop value enum
func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateWebauthnUserVerificationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, githubComPocketIdPocketIdBackendInternalDtoAppConfigUpdateDtoTypeWebauthnUserVerificationPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *GithubComPocketIDPocketIDBackendInternalDtoAppConfigUpdateDto) validateWebauthnUserVerification(formats strfmt.Registry) error {

	if err := validate.Required("webauthnUserVerification", "body", m.WebauthnUserVerification); err != nil {
		return err
	}

	// value enum
	if err := m.validateWebauthnUserVerificationEnum("webauthnUserVerification", "body", *m.WebauthnUserVerification); err != nil {
		return err
	}
