...
func NewGetWellKnownOpenidConfigurationParams() *GetWellKnownOpenidConfigurationParams {
	return NewGetWellKnownOpenidConfigurationParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetWellKnownOpenidConfigurationParams].
