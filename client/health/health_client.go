...
type ClientService interface {
	...
	// GetHealthz responds to healthchecks.
	GetHealthz(params *GetHealthzParams, opts ...ClientOption) (*GetHealthzNoContent, error)

	// GetHealthzContext responds to healthchecks.
	GetHealthzContext(ctx context.Context, params *GetHealthzParams, opts ...ClientOption) (*GetHealthzNoContent, error)

	SetTransport(transport runtime.ContextualTransport)
}

/*
GetHealthzresponds to healthchecks.
...
/*
GetHealthzContextresponds to healthchecks.

Responds with a successful status code to healthcheck requests.

Do not use the deprecated [GetHealthzParams.Context] with this method: it would be ignored.
*/
func (a *Client) GetHealthzContext(ctx context.Context, params *GetHealthzParams, opts ...ClientOption) (*GetHealthzNoContent, error) {
