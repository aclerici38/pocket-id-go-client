...
func NewGetAPIUsersParams() *GetAPIUsersParams {
	return NewGetAPIUsersParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetAPIUsersParams].
