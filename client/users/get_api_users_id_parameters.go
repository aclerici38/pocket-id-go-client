...
func NewGetAPIUsersIDParams() *GetAPIUsersIDParams {
	return NewGetAPIUsersIDParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetAPIUsersIDParams].
...
func (o *GetAPIUsersIDParams) WithID(id string) *GetAPIUsersIDParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get API users ID params.
func (o *GetAPIUsersIDParams) SetID(id string) {
	o.ID = id
}
