...
func NewPostAPIUsersParams() *PostAPIUsersParams {
	return NewPostAPIUsersParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PostAPIUsersParams].
...
// WithUser adds the user to the post API users params.
func (o *PostAPIUsersParams) WithUser(user *models.GithubComPocketIDPocketIDBackendInternalDtoUserCreateDto) *PostAPIUsersParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the post API users params.
func (o *PostAPIUsersParams) SetUser(user *models.GithubComPocketIDPocketIDBackendInternalDtoUserCreateDto) {
	o.User = user
}
